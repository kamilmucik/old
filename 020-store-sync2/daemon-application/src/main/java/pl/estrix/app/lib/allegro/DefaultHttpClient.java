...
//        HttpGet httpGet = new HttpGet(url);
        return getEntityAndReleaseConnection(httpPost, List.class);
    }
...
//            String str = encoder.encodeToString(("f0dddb5dc3bc4f8cb9faf362ddb98923:cqxudGg5Xvjs8NzYykVakpzDZBK7k7hijbPnaCKXpOceIGr0EjafZLBdMagGCtVf").getBytes());
//            String str = encoder.encodeToString((config.getConsumerKey()+":" + config.getConsumerSecret()).getBytes());
//            System.out.println("Encoded string: "+str);

//            byte[] decodedBytes = Base64.getDecoder().decode("2dwNcw3CQ74Xn9I:cqxudGg5Xvjs8NzYykVakpzDZBK7k7hijbPnaCKXpOceIGr0EjafZLBdMagGCtVf");
...
//            System.out.println("decodedString: " + decodedString);
            ...
            httpPost.setHeader(CONTENT_TYPE, APPLICATION_WWW);
//            httpPost.setHeader(AUTHORIZATION, "Basic " + str);
    ...
    @Override
    public Map postConnection(String url, String clientId, String base64Credential, Map<String, Object> object) {
        ...
        try {
            ...
            httpPost = new HttpPost(uriBuilder.build());
            httpPost.setHeader(CONTENT_TYPE, APPLICATION_WWW);
            httpPost.setHeader(AUTHORIZATION, "Basic " + base64Credential);
            return postEntity(object, httpPost);
        } catch (URISyntaxException e) {
            throw new RuntimeException(e);
        }
    ...
    private Map postEntity(Map<String, Object> objectForJson, HttpEntityEnclosingRequestBase httpPost) {
        try {
            HttpEntity entity = new ByteArrayEntity(this.mapper.writeValueAsBytes(objectForJson), ContentType.APPLICATION_FORM_URLENCODED);
...
//            Files.write(Paths.get("d:/output.html"), responseString.getBytes());
